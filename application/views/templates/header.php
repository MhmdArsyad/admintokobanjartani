...
<head>
    ...
    <title>Toko Banjar Tani | Dasbor</title>
    ...
    <link href="<?php echo base_url()?>sbadmin2/css/sb-admin-2.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href=" <?php echo base_url()?> index.html">
                ...
                <div class="sidebar-brand-text mx-3">Toko <br> Banjar Tani</div>
            </a>
